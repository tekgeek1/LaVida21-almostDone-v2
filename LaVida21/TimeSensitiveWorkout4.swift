...
class TimeSensitiveWorkout4: UIViewController {
    
    var bannerView: GADBannerView!
    
    @IBOutlet weak var TimeSensitivelogo: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        TimeSensitivelogo.layer.cornerRadius = 25
        TimeSensitivelogo.layer.masksToBounds = true
        TimeSensitivelogo.layer.borderColor = UIColor.white.cgColor
        TimeSensitivelogo.layer.borderWidth = 3
