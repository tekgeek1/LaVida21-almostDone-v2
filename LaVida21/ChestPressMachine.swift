...
class ChestPressMachine: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        maxWeightLiftedLabel.text = newMaxLiftedText.text
        updateDataGlobal(EntityVar: "Chest", ExeriseNameVar: "Chest Press Machine", value: maxWeightLiftedLabel.text!)
