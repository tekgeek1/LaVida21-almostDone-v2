...
class StiffLeggedDeadlifts: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Legs", ExeriseNameVar: "Stiff Leg Deadlifts", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Legs", ExeriseNameVar: "Stiff Leg Deadlifts", value: maxLiftedLabel.text!)
