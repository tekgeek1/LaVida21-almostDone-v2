...
class CableHammerCurls: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Biceps", ExeriseNameVar: "Cable Hammer Curl", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Biceps", ExeriseNameVar: "Cable Hammer Curl", value: maxLiftedLabel.text!)
