...
class InclineSupportedCurls: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Biceps", ExeriseNameVar: "Incline Supported Curls", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Biceps", ExeriseNameVar: "Incline Supported Curls", value: maxLiftedLabel.text!)
