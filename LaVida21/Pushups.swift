...
class Pushups: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Chest", ExeriseNameVar: "Pushups", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        retrieveDataGlobal(EntityVar: "Chest", ExeriseNameVar: "Pushups", value: maxLiftedLabel.text!)
