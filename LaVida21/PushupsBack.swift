...
class PushupsBack: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Back", ExeriseNameVar: "Back Pushup", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Chest", ExeriseNameVar: "Back Pushup", value: maxLiftedLabel.text!)
