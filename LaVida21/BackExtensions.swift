...
class BackExtensions: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Back", ExeriseNameVar: "Back Extension", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Back", ExeriseNameVar: "Back Extension", value: maxLiftedLabel.text!)
