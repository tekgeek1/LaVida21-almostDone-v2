//
//  BehindTheNeckLatPullDownMachine.swift
//  LaVida21
//
...
class BehindTheNeckLatPullDownMachine: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Back", ExeriseNameVar: "Behind The Neck Lat Pull Down Machine", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Back", ExeriseNameVar: "Behind The Neck Lat Pull Down Machine", value: maxLiftedLabel.text!)
