...
class Lying_Flat_Leg_Lifts: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Abs", ExeriseNameVar: "Lying Flat Leg Lift", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Abs", ExeriseNameVar: "Lying Flat Leg Lift", value: maxLiftedLabel.text!)
