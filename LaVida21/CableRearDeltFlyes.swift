...
class CableRearDeltFlyes: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Shoulders", ExeriseNameVar: "Cable Rear Delt Fly", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Shoulders", ExeriseNameVar: "Cable Rear Delt Fly", value: maxLiftedLabel.text!)
