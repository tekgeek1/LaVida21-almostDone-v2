//
//  TimeSensetiveChestWorkout3.swift
//  LaVida21
//
...
class TimeSensetiveChestWorkout3: UIViewController {
    ...
    @IBOutlet weak var TimeSensitiveWorkout: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        TimeSensitiveWorkout.layer.cornerRadius = 25
        TimeSensitiveWorkout.layer.masksToBounds = true
        TimeSensitiveWorkout.layer.borderColor = UIColor.white.cgColor
        TimeSensitiveWorkout.layer.borderWidth = 3
