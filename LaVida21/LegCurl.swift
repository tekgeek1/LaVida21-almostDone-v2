...
class LegCurl: UIViewController {
    ...
    @IBAction func newWeightedLiftedButton(_ sender: UIButton) {
        maxLiftedLabel.text = newMaxLiftedText.text
        updateDataGlobal(EntityVar: "Legs", ExeriseNameVar: "Leg Curl", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Legs", ExeriseNameVar: "Leg Curl", value: maxLiftedLabel.text!)
