//
//  DeclineStandingCableFlyes.swift
//  LaVida21
//
...
class DeclineStandingCableFlyes: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Chest", ExeriseNameVar: "Decline Standing Cable Fly", value: maxLiftedLabel.text!)
