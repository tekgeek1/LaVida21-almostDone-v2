...
class InclineSkullCrushers: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Triceps", ExeriseNameVar: "Incline Skull Crushers", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Triceps", ExeriseNameVar: "Incline Skull Crushers", value: maxLiftedLabel.text!)
