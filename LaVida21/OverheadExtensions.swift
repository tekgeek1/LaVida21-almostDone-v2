...
class OverheadExtensions: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Triceps", ExeriseNameVar: "Overhead Extensions", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Triceps", ExeriseNameVar: "Overhead Extensions", value: maxLiftedLabel.text!)
