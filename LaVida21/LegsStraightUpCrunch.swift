//
//  LegsStraightUpCrunch.swift
//  LaVida21
//
//  Created by Nathan Simmons on 12/29/18.
...
class LegsStraightUpCrunch: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Abs", ExeriseNameVar: "Leg Straight Up Crunch", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Abs", ExeriseNameVar: "Leg Straight Up Crunch", value: maxLiftedLabel.text!)
