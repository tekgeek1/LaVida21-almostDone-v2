...
class UpperChestWorkout2: UIViewController {
    ...
    @IBOutlet weak var UpperChestLogo: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        UpperChestLogo.layer.cornerRadius = 20
        UpperChestLogo.layer.masksToBounds = true
        UpperChestLogo.layer.borderColor = UIColor.white.cgColor
        UpperChestLogo.layer.borderWidth = 3
