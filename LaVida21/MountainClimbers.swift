...
class MountainClimbers: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Abs", ExeriseNameVar: "Mountain Climbers", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Abs", ExeriseNameVar: "Mountain Climbers", value: maxLiftedLabel.text!)
