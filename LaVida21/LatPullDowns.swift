...
class LatPullDowns: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Back", ExeriseNameVar: "Lat Pulldown", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Back", ExeriseNameVar: "Lat Pulldown", value: maxLiftedLabel.text!)
