...
class HangCleans: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Shoulders", ExeriseNameVar: "Hang Clean", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Shoulders", ExeriseNameVar: "Hang Clean", value: maxLiftedLabel.text!)
