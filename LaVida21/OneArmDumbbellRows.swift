...
class OneArmDumbbellRows: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Back", ExeriseNameVar: "One Arm Dumbbell Rows", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Back", ExeriseNameVar: "One Arm Dumbbell Rows", value: maxLiftedLabel.text!)
