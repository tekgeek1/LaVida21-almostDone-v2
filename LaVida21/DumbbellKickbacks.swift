...
class DumbbellKickbacks: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Triceps", ExeriseNameVar: "Dumbbell Kickbacks", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Triceps", ExeriseNameVar: "Dumbbell Kickbacks", value: maxLiftedLabel.text!)
