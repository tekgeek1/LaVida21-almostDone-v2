...
class ReverseGripPushdowns: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Triceps", ExeriseNameVar: "Reverse Grip Pushdowns", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Triceps", ExeriseNameVar: "Reverse Grip Pushdowns", value: maxLiftedLabel.text!)
