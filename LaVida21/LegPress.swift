...
class LegPress: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Legs", ExeriseNameVar: "Leg Press", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Legs", ExeriseNameVar: "Leg Press", value: maxLiftedLabel.text!)
