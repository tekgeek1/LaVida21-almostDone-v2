...
class BenchPress: UIViewController {
    
    var bannerView: GADBannerView!

    @IBOutlet weak var WorkoutData: UILabel!
    @IBOutlet weak var AlternativeWorkouts: UILabel!
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Chest", ExeriseNameVar: "Bench Press", value: maxLiftedLabel.text!)
