...
class DumbbellWalkingLunges: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Legs", ExeriseNameVar: "Dumbbell Walking Lunges", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Legs", ExeriseNameVar: "Dumbbell Walking Lunges", value: maxLiftedLabel.text!)
