...
class HangingLegRaises: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Abs", ExeriseNameVar: "Hanging Leg Raise", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Abs", ExeriseNameVar: "Hanging Leg Raise", value: maxLiftedLabel.text!)
