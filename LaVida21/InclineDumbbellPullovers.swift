//
//  InclineDumbbellPullovers.swift
//  LaVida21
//
...
class InclineDumbbellPullovers: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Chest", ExeriseNameVar: "Incline Dumbbell Pullovers", value: maxLiftedLabel.text!)
