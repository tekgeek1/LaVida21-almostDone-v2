...
class CableUprightRow: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Shoulders", ExeriseNameVar: "Cable Upright Row", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Shoulders", ExeriseNameVar: "Cable Upright Row", value: maxLiftedLabel.text!)
