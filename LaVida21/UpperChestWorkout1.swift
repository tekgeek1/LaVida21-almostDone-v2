...
class UpperChestWorkout1: UIViewController {

    var bannerView: GADBannerView!
    
    @IBOutlet weak var UpperChestWorkoutLabel: UIImageView!
    ...
    @IBOutlet weak var WorkoutThing: UIButton!
    ...
    override func viewDidLoad() {
        ...
        UpperChestWorkoutLabel.layer.cornerRadius = 20
        UpperChestWorkoutLabel.layer.masksToBounds = true
        UpperChestWorkoutLabel.layer.borderColor = UIColor.white.cgColor
        UpperChestWorkoutLabel.layer.borderWidth = 3
        ...
        WorkoutThing.layer.cornerRadius = 20
        WorkoutThing.layer.masksToBounds = true
        WorkoutThing.layer.borderColor = UIColor.white.cgColor
        WorkoutThing.layer.borderWidth = 2
