...
class SeatedDumbbellCurls: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Biceps", ExeriseNameVar: "Seated Dumbbell Curls", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Biceps", ExeriseNameVar: "Seated Dumbbell Curls", value: maxLiftedLabel.text!)
