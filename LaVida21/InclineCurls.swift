...
class InclineCurls: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Biceps", ExeriseNameVar: "Incline Curls", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Biceps", ExeriseNameVar: "Incline Curls", value: maxLiftedLabel.text!)
