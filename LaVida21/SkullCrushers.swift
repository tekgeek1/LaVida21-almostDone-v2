...
class SkullCrushers: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Triceps", ExeriseNameVar: "Skull Crushers", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Triceps", ExeriseNameVar: "Skull Crushers", value: maxLiftedLabel.text!)
