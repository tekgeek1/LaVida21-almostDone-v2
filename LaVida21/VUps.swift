...
class VUps: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: Any) {
        ...
        updateDataGlobal(EntityVar: "Abs", ExeriseNameVar: "V Ups", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Abs", ExeriseNameVar: "V Ups", value: maxLiftedLabel.text!)
