...
class InclineDumbbellPress: UIViewController {
    ...
    @IBOutlet weak var newMaxLiftedTest: UITextField!
    @IBAction func newWeightLiftedButton(_ sender: Any) {
        maxWeightLiftedLabel.text = newMaxLiftedTest.text
        updateDataGlobal(EntityVar: "Chest", ExeriseNameVar: "Inclined Dumbbell Press", value: maxWeightLiftedLabel.text!)
