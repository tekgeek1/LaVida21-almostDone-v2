//
//  DumbbellRomanianDeadlifts.swift
//  LaVida21
//
...
class DumbbellRomanianDeadlifts: UIViewController {
    ...
    @IBAction func newWeightLiftedButton(_ sender: UIButton) {
        ...
        updateDataGlobal(EntityVar: "Legs", ExeriseNameVar: "Dumbbell Roman Dead Lift", value: maxLiftedLabel.text!)
    ...
    override func viewDidLoad() {
        ...
        retrieveDataGlobal(EntityVar: "Legs", ExeriseNameVar: "Dumbbell Roman Dead Lift", value: maxLiftedLabel.text!)
